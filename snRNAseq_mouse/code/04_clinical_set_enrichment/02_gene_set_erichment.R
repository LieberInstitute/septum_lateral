...
# 1  1.1839041 4.342524e-03       Chol    801    1360      all enrichment     0.1
# 2  0.3216382 1.000000e+00       Chol    190     602 positive enrichment     0.1
# 3  3.8836483 9.584513e-54       Chol    611     758 negative enrichment     0.1
# 4  1.6941314 7.399120e-16        ChP    557    1360      all enrichment     0.1
# 5  0.2349213 1.000000e+00        ChP     67     602 positive enrichment     0.1
# 6  5.0234218 6.904242e-89        ChP    490     758 negative enrichment     0.1
# 7  1.2189418 9.205241e-04       Endo    729    1360      all enrichment     0.1
# 8  0.2816549 1.000000e+00       Endo    146     602 positive enrichment     0.1
# 9  4.0002444 1.339747e-60       Endo    583     758 negative enrichment     0.1
# 10 1.2343742 4.575959e-04  Ependymal    724    1360      all enrichment     0.1
# 11 0.2837443 1.000000e+00  Ependymal    144     602 positive enrichment     0.1
# 12 4.0145038 2.617540e-61  Ependymal    580     758 negative enrichment     0.1
# 13 1.1088073 5.703782e-02        IoC    823    1360      all enrichment     0.1
# 14 0.3218454 1.000000e+00        IoC    206     602 positive enrichment     0.1
# 15 3.5978296 1.154929e-46        IoC    617     758 negative enrichment     0.1
# 16 1.6826648 3.375873e-15         LS    532    1360      all enrichment     0.1
# 17 0.2227243 1.000000e+00         LS     60     602 positive enrichment     0.1
# 18 4.8719544 1.304711e-85         LS    472     758 negative enrichment     0.1
# 19 1.0701686 1.567955e-01      Micro    865    1360      all enrichment     0.1
# 20 0.3202850 1.000000e+00      Micro    228     602 positive enrichment     0.1
# 21 3.6835028 1.283170e-44      Micro    637     758 negative enrichment     0.1
# 22 1.2809362 4.897104e-05         MS    670    1360      all enrichment     0.1
# 23 0.2444891 1.000000e+00         MS    111     602 positive enrichment     0.1
# 24 4.2379306 1.098409e-68         MS    559     758 negative enrichment     0.1
# 25 1.1228233 3.764875e-02      Mural    820    1360      all enrichment     0.1
# 26 0.3261351 1.000000e+00      Mural    205     602 positive enrichment     0.1
# 27 3.6055438 3.634314e-47      Mural    615     758 negative enrichment     0.1
# 28 1.3098820 1.101963e-05 Neuroblast    660    1360      all enrichment     0.1
# 29 0.2392201 1.000000e+00 Neuroblast    105     602 positive enrichment     0.1
# 30 4.3429908 2.104907e-71 Neuroblast    555     758 negative enrichment     0.1
# 31 1.2134485 1.213996e-03      Oligo    767    1360      all enrichment     0.1
# 32 0.3041092 1.000000e+00      Oligo    168     602 positive enrichment     0.1
# 33 4.0052977 2.301670e-58      Oligo    599     758 negative enrichment     0.1
# 34 1.3842783 1.964804e-07        OPC    620    1360      all enrichment     0.1
# 35 0.2276607 1.000000e+00        OPC     88     602 positive enrichment     0.1
# 36 4.4381449 2.715118e-75        OPC    532     758 negative enrichment     0.1
# 37 1.3776084 2.869702e-07       Sept    622    1360      all enrichment     0.1
# 38 0.2285101 1.000000e+00       Sept     89     602 positive enrichment     0.1
# 39 4.4189447 8.272987e-75       Sept    533     758 negative enrichment     0.1
# 40 1.0782868 1.303533e-01        Str    864    1360      all enrichment     0.1
# 41 0.3210299 1.000000e+00        Str    227     602 positive enrichment     0.1
# 42 3.7203735 2.419678e-45        Str    637     758 negative enrichment     0.1
# 43 1.1583487 1.152494e-02       Thal    813    1360      all enrichment     0.1
# 44 0.3266551 1.000000e+00       Thal    199     602 positive enrichment     0.1
# 45 3.7591492 1.379496e-50       Thal    614     758 negative enrichment     0.1
# 46 1.1146684 4.808382e-02       TNoS    821    1360      all enrichment     0.1
# 47 0.3256236 1.000000e+00       TNoS    206     602 positive enrichment     0.1
# 48 3.5706133 1.996935e-46       TNoS    615     758 negative enrichment     0.1
# 49 1.3453694 1.631918e-06   TT.IG.SH    646    1360      all enrichment     0.1
# 50 0.2341909 1.000000e+00   TT.IG.SH     98     602 positive enrichment     0.1
# 51 4.4335286 5.025350e-74   TT.IG.SH    548     758 negative enrichment     0.1
# 52 1.1777769 5.535827e-03      Astro    804    1360      all enrichment     0.1
# 53 0.3250915 1.000000e+00      Astro    193     602 positive enrichment     0.1
# 54 3.8260189 1.594080e-52      Astro    611     758 negative enrichment     0.1

enrichTab_FDR01 <- gene_set_enrichment(gene_list = gene_list_FDR01, modeling_results = modeling_results, model_type = "enrichment")
enrichTab_FDR01
#           OR         Pval       test NumSig SetSize       ID model_type fdr_cut
# 1  0.7201371 9.955595e-01       Chol    122     254      all enrichment     0.1
# 2  0.4047635 1.000000e+00       Chol     66     191 positive enrichment     0.1
# 3  6.4335193 1.196493e-08       Chol     56      63 negative enrichment     0.1
# 4  0.7323689 9.874757e-01        ChP     66     254      all enrichment     0.1
# 5  0.1857971 1.000000e+00        ChP     16     191 positive enrichment     0.1
# 6  8.3487628 1.114420e-14        ChP     50      63 negative enrichment     0.1
# 7  0.6600557 9.994517e-01       Endo    102     254      all enrichment     0.1
# 8  0.3338661 1.000000e+00       Endo     49     191 positive enrichment     0.1
# 9  5.4023660 1.330319e-08       Endo     53      63 negative enrichment     0.1
# 10 0.6654264 9.993085e-01  Ependymal    101     254      all enrichment     0.1
# 11 0.3327230 1.000000e+00  Ependymal     48     191 positive enrichment     0.1
# 12 5.5357139 7.790609e-09  Ependymal     53      63 negative enrichment     0.1
# 13 0.7038290 9.973599e-01        IoC    128     254      all enrichment     0.1
# 14 0.4129035 1.000000e+00        IoC     72     191 positive enrichment     0.1
# 15 5.7214936 1.270046e-07        IoC     56      63 negative enrichment     0.1
# 16 0.7389478 9.841231e-01         LS     63     254      all enrichment     0.1
# 17 0.1725121 1.000000e+00         LS     14     191 positive enrichment     0.1
# 18 8.1608066 1.051887e-14         LS     49      63 negative enrichment     0.1
# 19 0.7400886 9.912956e-01      Micro    141     254      all enrichment     0.1
# 20 0.4691333 9.999999e-01      Micro     85     191 positive enrichment     0.1
# 21 4.8798841 2.257994e-06      Micro     56      63 negative enrichment     0.1
# 22 0.5973143 9.999574e-01         MS     84     254      all enrichment     0.1
# 23 0.2388725 1.000000e+00         MS     32     191 positive enrichment     0.1
# 24 5.9564898 5.700690e-10         MS     52      63 negative enrichment     0.1
# 25 0.7177497 9.958342e-01      Mural    128     254      all enrichment     0.1
# 26 0.4209919 1.000000e+00      Mural     72     191 positive enrichment     0.1
# 27 5.8299309 8.823116e-08      Mural     56      63 negative enrichment     0.1
# 28 0.5812538 9.999793e-01 Neuroblast     80     254      all enrichment     0.1
# 29 0.2130867 1.000000e+00 Neuroblast     28     191 positive enrichment     0.1
# 30 6.2396232 1.838616e-10 Neuroblast     52      63 negative enrichment     0.1
# 31 0.7038607 9.973630e-01      Oligo    113     254      all enrichment     0.1
# 32 0.3766459 1.000000e+00      Oligo     58     191 positive enrichment     0.1
# 33 6.2410022 5.368606e-09      Oligo     55      63 negative enrichment     0.1
# 34 0.6102602 9.998763e-01        OPC     74     254      all enrichment     0.1
# 35 0.1891390 1.000000e+00        OPC     22     191 positive enrichment     0.1
# 36 7.3286987 2.880502e-12        OPC     52      63 negative enrichment     0.1
# 37 0.6163673 9.998419e-01       Sept     75     254      all enrichment     0.1
# 38 0.1971528 1.000000e+00       Sept     23     191 positive enrichment     0.1
# 39 7.2588604 3.730497e-12       Sept     52      63 negative enrichment     0.1
# 40 0.7345770 9.926059e-01        Str    140     254      all enrichment     0.1
# 41 0.4631464 9.999999e-01        Str     84     191 positive enrichment     0.1
# 42 4.9234972 1.941246e-06        Str     56      63 negative enrichment     0.1
# 43 0.7278418 9.943339e-01       Thal    126     254      all enrichment     0.1
# 44 0.4210690 1.000000e+00       Thal     70     191 positive enrichment     0.1
# 45 6.0992009 3.595827e-08       Thal     56      63 negative enrichment     0.1
# 46 0.7113415 9.966108e-01       TNoS    128     254      all enrichment     0.1
# 47 0.4172688 1.000000e+00       TNoS     72     191 positive enrichment     0.1
# 48 5.7800185 1.043165e-07       TNoS     56      63 negative enrichment     0.1
# 49 0.6076834 9.999120e-01   TT.IG.SH     79     254      all enrichment     0.1
# 50 0.2172528 1.000000e+00   TT.IG.SH     27     191 positive enrichment     0.1
# 51 6.6360946 3.898949e-11   TT.IG.SH     52      63 negative enrichment     0.1
# 52 0.7103653 9.967607e-01      Astro    122     254      all enrichment     0.1
# 53 0.3993264 1.000000e+00      Astro     66     191 positive enrichment     0.1
# 54 6.3496877 1.574342e-08      Astro     56      63 negative enrichment     0.1
