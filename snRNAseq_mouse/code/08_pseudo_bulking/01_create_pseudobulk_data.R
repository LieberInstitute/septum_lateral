...
sce.ls.LS.Sept <- filterSCE(sce.ls, cellType.final %in% LSept_names)
sce.ls.neuronal <- filterSCE(sce.ls, cellType.final %in% neuronal_names)
sce.ls.neuronal.broad <- filterSCE(sce.ls, cellType.broad %in% neuronalbr_names)
