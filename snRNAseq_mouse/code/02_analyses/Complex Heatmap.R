...
markers  <- c("Snap25", "Slc17a7", "Slc17a6", "Gad1", "Gad2", "Mbp", "Mobp", "Pdgfra",
...
markers_all <- c("Sv2b", "Pcsk5", "Satb2", #TT/IG/SH
                 "Samd3", "Sema3a", #TNoS
                 "Synpo2", #Thal
...
markers  <- c("Sv2b", "Pcsk5", "Satb2", "Samd3", "Sema3a", "Synpo2", "Bcl11b", "Rarb",
...
markers_all <- c("Kcnmb2", "Gpr176", "Col19a1", #LS_C
                 "Htr7","Baiap3", #LS_D
                 "Nos1", "Npy", "Sst", #LS_L
...
markers  <- c("Kcnmb2", "Gpr176", "Col19a1", "Htr7","Baiap3","Nos1", "Npy", "Sst",  "Stac2", "Grid2ip", "Trpc6", "Trpc3", 
